...
export default function Home() {
  ...
  const EMAILJS_CONFIG = {
    SERVICE_ID: "service_gj5rpxl", // Remplacez par votre Service ID EmailJS
    TEMPLATE_ID: "template_bmdos0d", // Remplacez par votre Template ID EmailJS
    PUBLIC_KEY: "I_m-qOeiaND7XPzLS" // Remplacez par votre Public Key EmailJS
  };
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
        ...
        EMAILJS_CONFIG.TEMPLATE_ID,
        {
          ...
          message: devisData.projet,
          to_name: "Ko'Sdevs Devis Projet",
          reply_to: devisData.email
        },
          ...
          >
            ...
            {status === "error" && (
              <motion.div 
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                className="mb-4 p-3 bg-red-900 bg-opacity-30 text-red-400 rounded-lg font-semibold flex items-center border border-red-800"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
