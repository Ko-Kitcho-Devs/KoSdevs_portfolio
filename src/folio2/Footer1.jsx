    ...
    <footer className="bg-gray-900 border-t border-gray-800 py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* Colonne 1 - À propos */}
          <div>
            <h3 className="text-xl font-bold text-gray-100 mb-4">Ko'S<span className="text-teal-300">devs</span></h3>
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-100 mb-4 space-x-3">Liens <span className="text-teal-300">rapides</span></h3>
          ...
          {/* Colonne 3 - Contact */}
          <div>
            <h3 className="text-xl font-bold text-gray-100 mb-4 space-x-3">Restons <span className="text-teal-300">en contact</span></h3>
            <p className="text-gray-400 mb-4">
